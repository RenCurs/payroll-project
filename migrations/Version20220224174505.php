...
final class Version20220224174505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE services_charge (id INT NOT NULL, employee_id INT DEFAULT NULL, type VARCHAR(60) NOT NULL, name VARCHAR(100) NOT NULL, cost DOUBLE PRECISION NOT NULL, date DATE NOT NULL, PRIMARY KEY(id))');
